...
#define FFMPEG_CONFIGURATION "--arch=aarch64 --enable-shared --enable-pthreads --enable-version3 --enable-cross-compile --cross-prefix=aarch64-linux-gnu- --target-os=linux --enable-vulkan --enable-libaom --enable-zlib --disable-doc --logfile=log.txt --disable-debug --extra-cflags='-I/home/aiusubov/zlib,-I/home/aiusubov/aom_build/release/include' --extra-ldflags='-Wl,-rpath=$ORIGIN,-L/home/aiusubov/zlib,-L/home/aiusubov/aom_build/release/lib' --enable-rpath --disable-sndio"
