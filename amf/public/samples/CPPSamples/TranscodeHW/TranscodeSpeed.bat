...
TranscodeHW.exe -input %1 -output %2 -width 1920 -height 1080 -usage transcoding -qualitypreset speed -RateControlMethod cqp -targetBitrate 5000000 -FRAMES 1000 -engine dx11 -threadcount 1 -BPicturesPattern 0 -IDRPeriod 20 -QPI 30 -QPP 30
