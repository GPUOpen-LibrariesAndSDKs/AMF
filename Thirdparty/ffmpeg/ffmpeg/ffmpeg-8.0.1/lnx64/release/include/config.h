...
#define FFMPEG_CONFIGURATION "--arch=x86_64 --enable-shared --enable-pthreads --enable-version3 --target-os=linux --enable-openssl --enable-vulkan --enable-libaom --enable-zlib --logfile=log.txt --disable-debug --extra-cflags='-I/home/aiusubov/ffmpeg/zlib/lnx64/include,-I/home/aiusubov/ffmpeg/aom/lnx64/include,-I/home/aiusubov/ffmpeg/openssl/lnx64/include' --extra-ldflags='-Wl,-rpath=$ORIGIN,-L/home/aiusubov/ffmpeg/zlib/lnx64/lib,-L/home/aiusubov/ffmpeg/aom/lnx64/lib,-L/home/aiusubov/ffmpeg/openssl/lnx64/lib64' --pkg-config-flags=--static --enable-rpath --disable-sndio"
