...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86_64 --enable-shared --enable-w32threads --enable-version3 --enable-openssl --enable-libaom --disable-debug --extra-cflags=-Zi --extra-ldflags=-DEBUG --logfile=log.txt"
