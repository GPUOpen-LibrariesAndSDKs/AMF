...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86 --enable-shared --enable-w32threads --enable-version3 --enable-libaom --enable-zlib --disable-debug --extra-cflags=-Zi --extra-ldflags=-DEBUG --logfile=log.txt"
