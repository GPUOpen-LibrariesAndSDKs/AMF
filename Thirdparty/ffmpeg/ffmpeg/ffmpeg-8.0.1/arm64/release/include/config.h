...
#define FFMPEG_CONFIGURATION "--pkg-config=/usr/bin/pkg-config --arch=aarch64 --enable-shared --enable-pthreads --enable-version3 --enable-cross-compile --target-os=linux --enable-openssl --arch=arm64 --cross-prefix=aarch64-linux-gnu- --enable-vulkan --enable-libaom --enable-zlib --disable-doc --logfile=log.txt --disable-debug --extra-cflags='-I/home/aiusubov/ffmpeg/zlib/arm64/include,-I/home/aiusubov/ffmpeg/aom/arm64/include,-I/home/aiusubov/ffmpeg/openssl/arm64/include' --extra-ldflags='-Wl,-rpath=$ORIGIN,-L/home/aiusubov/ffmpeg/zlib/arm64/lib,-L/home/aiusubov/ffmpeg/aom/arm64/lib,-L/home/aiusubov/ffmpeg/openssl/arm64/lib' --pkg-config-flags=--static --enable-rpath --disable-sndio"
