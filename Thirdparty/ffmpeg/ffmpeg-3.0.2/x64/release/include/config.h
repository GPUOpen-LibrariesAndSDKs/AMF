...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --enable-memalign-hack --arch=x86_64 --target-os=win32 --disable-static --enable-shared --pkg-config=pkg-config --enable-version3 --enable-avresample --enable-runtime-cpudetect --disable-iconv --extra-cflags='-Z7 -Ic:/msys/mingw64/include' --extra-ldflags=-DEBUG --disable-debug"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 18.00.40629 for x64"
