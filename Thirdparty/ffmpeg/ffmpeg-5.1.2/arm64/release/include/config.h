...
#define FFMPEG_CONFIGURATION "--arch=aarch64 --enable-shared --enable-pthreads --enable-version3 --logfile=log.txt --enable-libaom --disable-debug --extra-cflags='-I/home/amd/ffmpeg/zlib-1.2.13,-I/home/amd/ffmpeg/aom_build/include' --extra-ldflags='-Wl,-rpath=$ORIGIN,-L/home/amd/ffmpeg/zlib-1.2.13,-L/home/amd/ffmpeg/aom_build/lib' --enable-rpath --disable-sndio"
