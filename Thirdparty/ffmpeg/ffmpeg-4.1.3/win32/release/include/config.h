...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86 --enable-shared --enable-w32threads --enable-avresample --enable-version3 --enable-openssl --disable-debug --extra-cflags=-Zi --extra-ldflags=-DEBUG"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.16.27031.1 for x86"
