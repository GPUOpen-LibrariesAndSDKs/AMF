...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86_64 --enable-shared --enable-w32threads --enable-avresample --disable-debug --extra-cflags=-Zi --extra-ldflags=-DEBUG"
