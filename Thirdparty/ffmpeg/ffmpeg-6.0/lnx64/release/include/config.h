...
#define FFMPEG_CONFIGURATION "--arch=x86_64 --enable-shared --enable-pthreads --enable-version3 --enable-libaom --logfile=log.txt --disable-debug --extra-cflags='-I/home/rhuts/FFMPEG_build/ffmpeg-6.0/zlib,-I/home/rhuts/FFMPEG_build/ffmpeg-6.0/aom/include' --extra-ldflags='-Wl,-rpath=$ORIGIN,-L/home/rhuts/FFMPEG_build/ffmpeg-6.0/zlib,-L/home/rhuts/FFMPEG_build/ffmpeg-6.0/aom/lib' --enable-rpath --disable-sndio"
