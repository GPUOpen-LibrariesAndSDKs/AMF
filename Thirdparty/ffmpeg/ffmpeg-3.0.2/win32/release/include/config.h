...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --enable-memalign-hack --arch=x86 --target-os=win32 --disable-static --enable-shared --pkg-config=pkg-config --enable-version3 --enable-avresample --enable-runtime-cpudetect --disable-iconv --extra-cflags='-Z7 -Ic:/msys/mingw32/include' --extra-ldflags=-DEBUG --disable-debug"
