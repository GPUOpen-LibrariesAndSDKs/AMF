...
#define FFMPEG_CONFIGURATION "--arch=aarch64 --enable-shared --enable-pthreads --enable-cross-compile --cross-prefix=aarch64-linux-gnu- --target-os=linux --enable-version3 --enable-zlib --logfile=log.txt --disable-debug --extra-cflags='-I/home/aiusubov/zlib-build-aarch64,-I/home/aiusubov/aom-build/include' --extra-ldflags='-Wl,-rpath=$ORIGIN,-L/home/aiusubov/zlib-build-aarch64,-L/home/aiusubov/aom-build/lib' --enable-rpath --disable-sndio"
