...
#define FFMPEG_CONFIGURATION "--arch=x86_64 --enable-shared --enable-pthreads --enable-version3 --enable-vulkan --enable-libaom --enable-zlib --logfile=log.txt --disable-debug --extra-cflags='-I/home/aiusubov/zlib,-I/home/aiusubov/aom_build/include' --extra-ldflags='-Wl,-rpath=$ORIGIN,-L/home/aiusubov/zlib,-L/home/aiusubov/aom_build/lib' --enable-rpath --disable-sndio"
