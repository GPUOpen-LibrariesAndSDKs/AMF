...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86_64 --enable-shared --enable-w32threads --enable-version3 --enable-openssl --enable-zlib --enable-libaom --disable-debug --extra-cflags=-Zi --extra-ldflags=-DEBUG --logfile=log.txt"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.29.30148 for x64"
