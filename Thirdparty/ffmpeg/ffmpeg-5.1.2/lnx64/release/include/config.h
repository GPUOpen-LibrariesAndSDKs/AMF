...
#define FFMPEG_CONFIGURATION "--arch=x86_64 --enable-shared --enable-pthreads --enable-version3 --logfile=log.txt --enable-libaom --disable-debug --extra-cflags='-I/home/amd/newFFMPEG/ffmpeg-5.1.2/zlib,-I/home/amd/newFFMPEG/aom_build/include' --extra-ldflags='-Wl,-rpath=$ORIGIN,-L/home/amd/newFFMPEG/ffmpeg-5.1.2/zlib,-L/home/amd/newFFMPEG/aom_build/lib' --enable-rpath --disable-sndio"
