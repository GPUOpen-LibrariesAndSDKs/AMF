...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --disable-debug --enable-shared --arch=x86_64 --enable-shared --enable-w32threads --enable-avresample --enable-version3 --enable-openssl --enable-libaom --prefix=/c/ffmpeg432-source/ffmpeg_msvc_x64_pdb --extra-ldflags=-DEBUG --extra-cflags=-Zi"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/c/ffmpeg432-source/ffmpeg_msvc_x64_pdb/share/ffmpeg"
#define AVCONV_DATADIR "/c/ffmpeg432-source/ffmpeg_msvc_x64_pdb/share/ffmpeg"
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.28.29914 for x64"
